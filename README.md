...
基于 Gemini API 的游戏图标批量生成工具，一次生成 3x3 或 5x5 排布的图标网格图片。

## 功能特性

- **文字生成模式**：输入描述，生成 9 个或 25 个风格统一的图标
- **风格迁移模式**：上传参考图，生成相同风格的新图标
- **多种网格布局**：支持 3x3（9 个图标）或 5x5（25 个图标）排布
- **一键导出**：直接下载网格排布的 PNG 图片
